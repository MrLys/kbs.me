...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //  ),
	[_DVORAK] = LAYOUT_65_iso_blocker(
        DV_DLR,     DV_PERC,        DV_7,       DV_5,       DV_3,       DV_1,       DV_9,       DV_0,       DV_2,       DV_4,       DV_6,       DV_8,       DV_TICK,    KC_BSPC,        KC_DEL,
		    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_ENT,         KC_PGUP,
		    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS,                 TO(3),
		    KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                 KC_UP,   KC_END,
		    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                                      KC_RALT, KC_RGUI,        KC_LEFT, KC_DOWN, KC_RGHT
    ),
	...
	[_SYMBOLS] = LAYOUT_65_iso_blocker(
        ...
        KC_NO,      KC_NO,        KC_NO,        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_UP,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      /*nothin*/      KC_NO,
        KC_ESC,     KC_NO,        KC_NO,        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_NO,      KC_NO,      KC_NO,      KC_NO,          KC_NO,
        KC_NO,      TO(1),        KC_NO,        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_UP,          KC_NO,      
        KC_LCTL,    LGUI(KC_NO),    KC_LALT,    /*----------------------------space-----------------------------*/      KC_SPC,     KC_NO,      TO(0),      KC_LEFT,    KC_DOWN,        KC_RGHT
    ),
