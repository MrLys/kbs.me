...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //      DV_DLR,     DV_PERC,        DV_7,         DV_5,       DV_3,       DV_1,       DV_9,       DV_0,       DV_2,       DV_4,           DV_6,       DV_8,       DV_TICK,        KC_BSPC,        KC_DEL,
	...
	//	    KC_LCTL,    LT(1, KC_LGUI), KC_LALT,      /*----------------------------space-----------------------------*/      KC_SPC,         KC_RALT,    MO(2),      KC_LEFT,        KC_DOWN,        KC_RGHT
  //  ),
	[_QWERTYA] = LAYOUT_65_iso_blocker(
        KC_GRV,    KC_1,           KC_2,         KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,           KC_0,       KC_MINS,    KC_EQL,         KC_BSPC,        KC_HOME,
		    KC_TAB,     KC_Q,           KC_W,         KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,           KC_P,       KC_LBRC,    KC_RBRC,        KC_ENT,         KC_PGUP,
		    KC_ESC,     KC_A,           KC_S,         KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,           KC_SCLN,    KC_QUOT,    KC_BSLS,                        TO(_QWERTY),
		    KC_LSFT,    KC_NUBS,        KC_Z,         KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,        KC_DOT,     KC_SLSH,    KC_RSFT,        KC_UP,          KC_END,
		    KC_LCTL,    KC_LALT,        KC_LGUI,     /*----------------------------space-----------------------------*/       KC_SPC,         KC_RGUI,    KC_RALT,    KC_LEFT,        KC_DOWN,        KC_RGHT
    ),
	[_NAVIGATION] = LAYOUT_65_iso_blocker(
        ...
        KC_TRNS,    MO(2),          KC_TRNS,      KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    LGUI(KC_M),    KC_TRNS,        KC_TRNS,    KC_TRNS,    KC_TRNS,        KC_UP,          KC_TRNS,
        KC_LCTL,    KC_TRNS,        KC_LALT,    /*----------------------------space-----------------------------*/        KC_SPC,         KC_TRNS,    TO(2),      LGUI(KC_LEFT),  LGUI(KC_DOWN),  LGUI(KC_RGHT)
    ),
	[_SYMBOLS] = LAYOUT_65_iso_blocker(
        KC_ESC,     KC_F1,          KC_F2,        KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,          KC_F10,     KC_F11,     KC_F12,         KC_F1,        KC_F1,
	...
	[_QWERTY] = LAYOUT_65_iso_blocker(
        QK_GESC,    KC_1,           KC_2,         KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,           KC_0,       KC_MINS,    KC_EQL,         KC_BSPC,        KC_HOME,
		    KC_TAB,     KC_Q,           KC_W,         KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,           KC_P,       KC_LBRC,    KC_RBRC,        KC_ENT,         KC_PGUP,
		    KC_CAPS,    KC_A,           KC_S,         KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,           KC_SCLN,    KC_QUOT,    KC_BSLS,                        TO(_QWERTYA),
		    KC_LSFT,    KC_NUBS,        KC_Z,         KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,        KC_DOT,     KC_SLSH,    KC_RSFT,        KC_UP,          KC_END,
